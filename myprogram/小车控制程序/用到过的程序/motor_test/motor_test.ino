...
double pi=3.1416;
double Setpoint1 =-1,Setpoint2 =-1,Setpoint3=-1.5;//设置期望速度
...
double kp1=10,kd1=0,ki1=25;
double kp2=10,kd2=0,ki2=25;
double kp3=10,kd3=0,ki3=25;
...
int AIN3=7;
int AIN4=6;
int PWM2=5;//电机2的AIN3 4和PWM2是电机输出引脚的定义
int AIN5=10;
int AIN6=9;
